...
const emailHasErrors = () => {
  ...
  const registerUser = async () => {
        ...
        } else if(emailHasErrors()||contrasenyaHasErrors()||usuarioHasErrors()){
  ...
  return (
    <ImageBackground 
      source={{ uri: uriImagen}} // URL o require(local)
    ...
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image source={require('../../assets/logoPNGsinletra.png')} style={styles.image} />
      </View>

      <View style={styles.formContainer}>
        <View style={{flexDirection:"row"}}>
          <Text style={styles.title}>Unete a </Text>
          <Text style={{...styles.title,color:"#33FF00"}}>BESTBUILDER!</Text>
        </View>
        ...
        <TextInput
          ...
          />
          {usuarioHasErrors()&&(
            <HelperText type="error">Invalid username, you need at least 3 characters</HelperText>
          )}
          <TextInput
            style={styles.input}
          ...
          {contrasenyaHasErrors() && (
            <HelperText type="error"> Invalid password, you need 8 characters, a capital letter, a lowercase letter, and a number.</HelperText>
          )}
          <TextInput
            style={styles.input}
        ...
        <View style={styles.loginContainer}>
          ...
          <Pressable onPress={()=>{props.navigation.navigate("Login")}}>
            <Text style={{...styles.textRegister,color:"#33FF00"}}>  Logueate</Text>
          </Pressable>
        </View>
      </View>          </View>
      </View>  
